    ...
    public static void main(String[] args) {
        ...
        while ((player_position1) <= 100 || (player_position2 <= 100)) {
            if (pos == 0) {
                ...
                count++;
                System.out.println("player1 dice number is" + " " + dice);
                if (dice != 0) {
                    player_position1 = player_position1 + dice;
                    System.out.println("After dice roll player position is " + " " + player_position1);
                    if (player_position1 > 100) {
                        player_position1 = player_position1 - dice;
                        System.out.println("player1 position is" + " " + player_position1);
                    }
                    if (player_position1 == 100) {
                        System.out.println("player1 won the match" + " " + player_position1);
                        break;
                    }
                    for (int i = 0; i < 5; i++) {
                        if (ladder[i] == player_position1) {
                            ...
                            System.out.println("player gets ladder position" + " " + player_position1);
                            System.out.println("player_position1 will play again");
                        } else if (snake[i] == player_position1) {
                            player_position1 = bite_position[i];
                            System.out.println("player bitten by snake position" + " " + player_position1);
                        }
                    ...
                    if (dice != 0) {
                        ...
                        for (int i = 0; i < 5; i++) {
                            if (ladder[i] == player_position2) {
                                ...
                                System.out.println("player gets ladder position" + " " + player_position2);
                                System.out.println("player_position2 will play again");
                            } else if (snake[i] == player_position2) {
                                player_position2 = bite_position[i];
                                System.out.println("player bitten  by snake position" + " " + player_position2);
                            }
                        }
                    }
                }
